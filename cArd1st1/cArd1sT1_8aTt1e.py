...
cards_kinds = {'강철 덫': Cards('강철 덫', '없음', 0, 5, ['강철 덫', '굴살이'], False),
               ...
               '해골': Cards('해골', '없음', 0, 1, '취약성', True),
               '뼈 무더기': Cards('뼈 무더기', '없음', 0, 1, '팽창', True),
               '드라우그르': Cards('드라우그르', ['뼈', 1], 0, 1, '해빙', True),
               ...
               '파라오의 애완동물': Cards('파라오의 애완동물', ['뼈', 6], 0, 2, ['많은 목숨', ''], True),
               '본하운드': Cards('본하운드', ['뼈', 7], 2, 3, '', True),
               '미라 제왕': Cards('미라 제왕', ['뼈', 8], 3, 3, '없음', True),
               '목 없는 기사': Cards('목 없는 기사', ['뼈', 13], 5, 5, ['이동', '비행'], True),
               '루비 목스': Cards('미라 제왕', ['뼈', 8], 3, 3, '없음', True),
               '사파이어 목스': Cards('미라 제왕', ['뼈', 8], 3, 3, '없음', True),
               '에메랄드 목스': Cards('미라 제왕', ['뼈', 8], 3, 3, '없음', True),
               '블린의 목스': Cards('미라 제왕', ['뼈', 8], 3, 3, '없음', True),
               '고란즈의 목스': Cards('미라 제왕', ['뼈', 8], 3, 3, '없음', True),
               '오를루의 목스': Cards('미라 제왕', ['뼈', 8], 3, 3, '없음', True),
               '견습 마법사': Cards('미라 제왕', ['뼈', 8], 3, 3, '없음', True),
               '붉은 마법사': Cards('미라 제왕', ['뼈', 8], 3, 3, '없음', True),
               '루비 골렘': Cards('미라 제왕', ['뼈', 8], 3, 3, '없음', True),
               '마법 기사': Cards('미라 제왕', ['뼈', 8], 3, 3, '없음', True),
               '파란 마법사': Cards('미라 제왕', ['뼈', 8], 3, 3, '없음', True),
               '파란 포자마법사': Cards('미라 제왕', ['뼈', 8], 3, 3, '없음', True),
               '유영 마법사': Cards('미라 제왕', ['뼈', 8], 3, 3, '없음', True),
               '포스 마법사': Cards('미라 제왕', ['뼈', 8], 3, 3, '없음', True),
               '초록 마법사': Cards('미라 제왕', ['뼈', 8], 3, 3, '없음', True),
               '견습 현자': Cards('미라 제왕', ['뼈', 8], 3, 3, '없음', True),
               '자극 마법사': Cards('미라 제왕', ['뼈', 8], 3, 3, '없음', True),
               '미식 마법사': Cards('미라 제왕', ['뼈', 8], 3, 3, '없음', True),
               '마스터 블린': Cards('미라 제왕', ['뼈', 8], 3, 3, '없음', True),
               '마스터 고란즈': Cards('미라 제왕', ['뼈', 8], 3, 3, '없음', True),
               '마스터 오를루': Cards('미라 제왕', ['뼈', 8], 3, 3, '없음', True)}

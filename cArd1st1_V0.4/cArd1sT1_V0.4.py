...
# 플레이어의 진행 목록
deck = []
# collection = {'고양이': 0, '늑대': 0, '아기 늑대': 0, '다람쥐': 0, '다람쥐 공': 0, '담비': 0, '두더지': 0, '두더지인간': 0, '무스': 0,
#               '새끼 무스': 0, '물총새': 0, '민물 거북': 0, '민물 수달': 0, '매': 0, '블러드하운드': 0, '비둘기': 0, '사마귀신': 0,
#               '살무사': 0, '스컹크': 0, '포자스컹크': 0, '알파': 0, '우라율리': 0, '우로보로스': 0, '코요테': 0, '큰까마귀': 0,
#               '향유고래': 0, '황소개구리': 0, '회색곰': 0, '감시 드론': 0, '감시 포자': 0, '무효화 전도체': 0, 'L33pB0t': 0,
#               '고GI봇': 0, '버프 전도체': 0, '봄버봇': 0, '에너지봇': 0, '49er': 0, '곤충 드론': 0, '공장 전도체': 0, '목스 모듈': 0,
#               '에너지 전도체': 0, '자동 장치': 0, '폭탄 부인': 0, '곡선넘이': 0, '두꺼운 드로이드': 0, '피버봇': 0, '사진충': 0,
#               '볼트하운드': 0, '스팀봇': 0, '더블 거너': 0, '해골': 0, '뼈 무더기': 0, '뼈 굴착자': 0, '포자굴착자': 0, '드라우그르': 0,
#               '도굴꾼': 0, '망령': 0, '밴시': 0, '뼈 마법사': 0, '좀비': 0, '네크로맨서': 0, '석관': 0, '유령선': 0, '익사한 영혼': 0,
#               '워커즈': 0, '죽은 손': 0, '프랭크 & 스타인': 0, '파라오의 애완동물': 0, '본하운드': 0, '미라 제왕': 0, '목 없는 기사': 0,
#               '루비 목스': 0, '사파이어 목스': 0, '에메랄드 목스': 0, '블린의 목스': 0, '고란즈의 목스': 0, '오를루의 목스': 0,
#               '견습 마법사': 0, '붉은 마법사': 0, '연습용 마법사': 0, '루비 골렘': 0, '마법 기사': 0, '파란 마법사': 0,
#               '파란 포자마법사': 0, '보석 광인': 0, '유영 마법사': 0, '포스 마법사': 0, '초록 마법사': 0, '견습 현자': 0, '근육 마법사': 0,
#               '자극 마법사': 0, '미식마법사': 0, '마스터 블린': 0, '마스터 고란즈': 0, '마스터 오를루': 0}
